        ...
        do {
            ...
            switch (tipe) {
                case 1: //Eliminacion de casa
                    ...
                    //Agregacion para permitir ir atras y asegurar que desea borrar
                ...
                case 3: //Eliminacion de mago
                    ...
                    //Agregacion para permitir ir atras y asegurar que desea borrar
                    Wizard wizard = wizards.stream().filter(w -> w.getId() == wizardId).findFirst().orElse(null);
                    if (wizard != null) {
                        String confirm = EnterVerify.valSorN(scn, "⚠️ Está a punto de eliminar al mago " + wizard.getName() + ". ¿Desea continuar? (S/N): ");
                        if (confirm.equalsIgnoreCase("S")) {
